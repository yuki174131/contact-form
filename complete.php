...
<html lang="ja">
    ...
    <body>
        <header>
            ...
            <a href="#" class="navbar-brand">お問い合わせ練習</a>
            ...
            <h2>送信内容</h2>
                <table class="table table-bordered mt-4">
                    <tbody>
                        <tr>
                            <th>会社名</th>
                            <td><?php print htmlspecialchars($_POST['company'], ENT_QUOTES, "UTF-8"); ?></td>
                        </tr>                         
                        <tr>
                            <th>氏名</th>
                        ...
                        <tr>
                            <th>内容</th>
                            <td><?php print nl2br(htmlspecialchars($_POST['content'], ENT_QUOTES, "UTF-8")); ?></td>
                        </tr>                            
